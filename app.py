...
if "member_df" not in st.session_state:
    RAW_DATA = {
        "참석": [True] * 33,
        "이름": ["김정수", "문상원", "박진원", "박기덕", "원종혁", "정상현", "이준협", "이상현", "유현재", "강병철", "한승오", "최낙민", "안치관", "김용태", "송미연",
               "김지현", "조인희", "김지원", "김수진", "김민표", "추진", "윤관호", "유명선", "추송", "안호성", "정민영", "이도연", "김정아", "권혁환", "심기홍",
               "홍소연", "장성민", "장혜린"],
        "에버리지": [226, 218, 214, 213, 212, 210, 209, 208, 205, 205, 204, 202, 199, 198, 197, 196, 193, 191, 190, 188,
                 187, 186, 178, 176, 173, 170, 165, 165, 165, 158, 156, 154, 196]
    }
